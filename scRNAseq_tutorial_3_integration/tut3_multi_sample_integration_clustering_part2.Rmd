...
p_cond_cca <- make_comparison_plot(merged_seurat, "umap.cca", "CCA", "condition", 
                                   colors = condition_colors)
p_cond_rpca <- make_comparison_plot(merged_seurat, "umap.rpca", "RPCA", "condition", 
                                    colors = condition_colors)
p_cond_harmony <- make_comparison_plot(merged_seurat, "umap.harmony", "Harmony", "condition", 
                                       colors = condition_colors)
p_cond_mnn <- make_comparison_plot(merged_seurat, "umap.mnn", "FastMNN", "condition", 
                                   colors = condition_colors)
...
methods_list <- list(
  ...
  "CCA" = list(obj = merged_seurat, reduction = "umap.cca"),
  "RPCA" = list(obj = merged_seurat, reduction = "umap.rpca"),
  "Harmony" = list(obj = merged_seurat, reduction = "umap.harmony"),
  "FastMNN" = list(obj = merged_seurat, reduction = "umap.mnn")
)
...
*Review metrics above* before imnplementing reduction choice in the following code chunk (set to `eval = FALSE` by default)

```{r implement_chosen_reduction, eval = FALSE}
